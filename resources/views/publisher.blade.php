...
<body>
    ...
    <div class="container">
        <div class="bg-secondary p-2">
            <h2 class="text-light fw-normal">Publisher List</h2>
        </div>
        ...
        @foreach ($publishers as $publisher)
              <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="{{ $publisher->image }}" class="card-img-top" id="displayImage" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">{{ $publisher->name }}</h5>
                      <p class="card-text">Address: <br> {{ $publisher->address }}</p>
                      <a href="{{ route('publisherDetail', $publisher->id) }}" class="btn btn-primary">Detail</a>
                    </div>
                </div>
              </div>
        @endforeach
